...
#
# Generated by Vivado on Sat Feb 08 21:00:15 +03 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../src/xdc/io.xdc"]"\
...
set file "$origin_dir/../src/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/../src/xdc/io.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/xdc/io.xdc"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xck26-sfvc784-2LV-c -flow {Vivado Implementation 2022} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
